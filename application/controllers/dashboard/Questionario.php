...
class Questionario extends CI_Controller {
	...
	public function index() {
		...
		set_tema('conteudo', load_modulo_dash('view_questionario_cadastro'));
		load_template();
	}
	...
	public function cadastrar() {
		...
		if ($this -> form_validation -> run()) {
			...
			$dados = elements(array('p#question'), $this -> input -> post());
	...
	public function deletar($id = null) {
		...
		if ($id != null) {
			...
			$dados = elements(array('p#question', 'p#fone', 'p#cidade_uf', 'p#senha', 'p#email'), $this -> input -> post());
