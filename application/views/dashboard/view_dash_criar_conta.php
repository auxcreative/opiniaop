...
<div class="container-fluid">
	<div class="container autencicacao">
		...
		<div class="row box login <?php echo ($this->uri->segment(3) == '' || $this->uri->segment(3) === 'validacao') ? '' : 'display'; ?>">
			<div class="col-lg-12">
		...
		<div class="row box recover <?php echo ($this->uri->segment(3) == 'recuperar_senha') ? '' : 'display'; ?>">
					...
					<div class="col-lg-12">
						<div class="col-lg-4 col-sm-12 offset-lg-4 bg-white">
							...
							<form action="<?php echo base_url('dashboard/autenticacao/criar_conta'); ?>" method="post" class="form form-estilo" >
								<div class="form-group">
									<input type="text" placeholder="Nome completo" class="form-control" name="nome" value="<?php echo set_value('nome','');  ?>" required="">
								</div>
								<div class="form-group">
									<div class="row">
										<div class="col-sm-3 col-xs-4">
										<input type="text" placeholder="11" class="form-control" name="ddd" value="<?php echo set_value('ddd','');  ?>" required="">
										</div> 
										<div class="col-sm-9 col-xs-8">
											<input type="text" placeholder="7=99999999" class="form-control" name="fone" value="<?php echo set_value('fone','');  ?>" required="">
										</div> 
									</div>
								</div>
								<div class="form-group">
									<input type="text" placeholder="Email" class="form-control" name="email" value="<?php echo set_value('email','');  ?>" required="">
								</div>
								<div class="form-group">
									<input type="password" placeholder="Senha" class="form-control" name="senha" value="<?php echo set_value('senha','');  ?>" required="">
								</div>
								<div class="form-group">
									<input type="password" placeholder="Repetir Senha" class="form-control" value="" name="confirma_senha">
								</div>
								<div class="form-group text-right">
